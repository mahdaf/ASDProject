 ...
 */
public class MainNotOOP extends JFrame {
    ...
    public static final Color COLOR_NOUGHT = new Color(58, 176, 24); // Blue #4CB5F5
            ...
            for (int row = 0; row < ROWS; ++row) {
                for (int col = 0; col < COLS; ++col) {
                    ...
                    if (board[row][col] == Seed.CROSS) {  // draw a 2-line cross
                        ...
                        g2d.drawRect(x1, y1, SYMBOL_SIZE, SYMBOL_SIZE); //ubah O menajdi kotak tadi
                    }
                }
            }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MainNotOOP(); // Let the constructor do the job
            }
        });
    }
}